<template>
  <div class="h-full w-full bg-white p-4 flex flex-col gap-y-4 relative">
    ...
    <div class="flex flex-col gap-y-4 flex-1 overflow-auto">
      ...
      <div class="flex flex-col gap-y-2">
        <span class="font-bold text-slate-700 text-lg">Sea Freight</span>
        <div class="w-full overflow-auto">
          <SecondaryTable
            :headers="seaFreightHeaders"
            :data="seaFreightRows"
            :type="'seaFreight'"
          />
          <div class="flex items-center gap-x-2 py-2">
            ...
            <button
              @click="handleDeleteRow('seaFreight')"
    ...
    <QuotationForm
      ...
      :data="seaFreightQuotationObject"
      :quotationType="'sea'"
    />
  </div>
</template>
...
import QuotationForm from '@/components/functions/bookings/quotation-form/type4/index.vue'
import {
  headersLocalCharges,
  dataLocalCharges,
  headersSeaFreight,
