    ...
    <div class="w-[1024px]">
        <div class="flex border-b border-slate-300 pb-4">
            ...
            <div class="text-slate-700 flex flex-col gap-y-2 ">
                <div>
                    <h1 class="text-2xl font-bold uppercase text-center">Rubick Logistics Joint Stock Company</h1>
                </div>
                <div class="space-x-2 max-w-[700px] whitespace-pre-wrap text-center">
                    <span class="font-bold">HaiPhong Head Office:</span>
                    <span>No 10/135 Trung Luc Street, Dang Lam Ward, Hai An District, Hai Phong City, Vietnam</span>
                </div>
                <div class="space-x-2 max-w-[700px] whitespace-pre-wrap text-center">
                    <span class="font-bold">Hanoi Branch:</span>
                    <span>No 02 Galaxy 3 Street, Galaxy Urban Area, Van Phuc, Ha Dong District, Hanoi City</span>
                </div>
                <div class="space-x-2 max-w-[700px] whitespace-wrap flex justify-evenly">
                    <div class="flex justify-center space-x-2">
                        <span>Hotline:</span>
                        <a href="tel:+84983350400" class="text-blue-500">+84 983 350 400</a>
                    </div>
                    <div class="flex justify-center space-x-2">
                        <span >Email:</span>
        ...
        <div class="flex flex-col gap-y-4 mt-4 text-slate-700">
            ...
            <div>
                <span class="text-lg font-bold uppercase block bg-slate-700 text-white px-2 py-1">I - Yêu cầu hỏi giá</span>
                <span class="text-md font-bold uppercase block bg-slate-200 px-2 py-1">1 - Chi tiết liên lạc</span>
                <div class="grid grid-cols-7 divide-x divide-y divide-slate-300 border border-slate-300 text-sm">
                    <div class="col-span-1 px-2 py-1 border-l border-t border-slate-300">
                ...
                <span class="text-md font-bold uppercase block bg-slate-200 px-2 py-1">2 - Chi tiết lô hàng</span>
                <div class="grid grid-cols-3 divide-x divide-y divide-slate-300 border border-slate-300 text-sm">
                    <div class="col-span-1 px-2 py-1 border-l border-t border-slate-300">
                ...
                <span class="text-lg font-bold uppercase block bg-slate-700 text-white px-2 py-1">II - Số lượng/ loại container</span>
                <div class="grid grid-cols-10 grid-rows-2 divide-x divide-y divide-slate-500 border border-slate-600 text-sm bg-slate-200">
                    <div class="col-span-4 row-span-2 px-2 flex items-center justify-center border-t border-slate-300">
                        <span class="font-bold">Các chi phí</span>
                    </div>
                    <div class="col-span-2 row-span-2 px-2 text-center flex items-center justify-center">
                        <span class="font-bold">Cost</span>
                    </div>
                    <div class="col-span-2 row-span-1 px-2 text-center flex items-center justify-center">
                        <span class="font-bold">Thành tiền</span>
                    </div>
                    <div class="col-span-1 row-span-1 col-start-7 row-start-2 text-center flex items-center justify-center">
                        <span class="font-bold">0</span>
                    </div>
                    <div class="col-span-1 row-span-1 col-start-8 row-start-2 text-center flex items-center justify-center">
                ...
                <div class="grid grid-cols-10 divide-x divide-y divide-slate-500 border border-slate-600 text-sm">
                    <!-- I - Exwork fee -->
                    <div class="col-span-1 row-span-4 px-2 py-1 border-l border-t border-slate-300 flex items-center justify-center">
                    ...
                    <div class="col-span-3 px-2 py-1 flex items-center justify-center">
                        <span class="font-bold">OF-Cước biển FCL/LCL</span>
                    </div>
                    <div class="col-span-1 px-2 py-1">
                        <span></span>
                    </div>
                    ...
                    <div class="col-span-1 row-span-7 px-2 py-1 border-l border-t border-slate-300 flex items-center justify-center text-center">
                        <span class="font-bold">III <br> Phí local charge</span>
                    </div>
                    ...
                    <div class="col-span-3 row-span-2 px-2 py-1 flex items-center justify-center">
                        <span class="uppercase font-bold">Tổng phí vận tải biển</span>
                    </div>
                    <div class="col-span-1 px-2 py-1">
                        <span></span>
                    </div>
                    ...
                    <!-- IV  -->
                    <div class="col-span-1 row-span-4 px-2 py-1 border-l border-t border-slate-300 flex items-center justify-center text-center">
                ...
                <span class="text-lg font-bold uppercase block bg-slate-700 text-white px-2 py-1">III - Ghi chú</span>
                <ol class="list-decimal list-inside text-sm mb-4">
                    <li>Báo giá chưa bao gồm VAT ... %</li>
                    <li>Báo giá chưa bao gồm các chi phí nâng, hạ, lưu cont, lưu kho,kiểm tra chất lượng, kiểm hóa (nếu có)…</li>
                ...
                <div class="border-t border-slate-300 py-2 flex justify-center space-x-80 border-b h-40">
                    ...
                    <div class="text-center">
                        <span class="font-bold block">Xác nhận báo giá</span>
                        <span class="text-xs">( Vui lòng ký, đóng dấu và fax lại chúng tôi)</span>
                    </div>
                </div>
